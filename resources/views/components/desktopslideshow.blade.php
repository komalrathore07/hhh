                ...
                <div class="carousel-inner">
                      ...
                      <div class="carousel-item active">
                            ...
                            <div class="view overlay">
                              ...
                              <div class="col-md-3 animated fadeInRight slow">
                              <img class="img-fluid slideshowimage" src=" {{asset('slideshow/slide1-2.png')}}" alt="Slide-1" style="width:100%;">
                              </div>
                     ...
                     <div class="carousel-item">
                            <div class="view overlay">
                              ...
                              <div align="left" class="col-md-5 p-5 mx-5">
                               ...
                               <a href="{{url('Shop/salwar-suit')}}" target="_blank" class="btn btn-dark"  >Order Now</a>
                              </div>
                              <div class="col-md-3 animated fadeInRight slow">
