                  ...
                  @csrf
                          <div class="col-md-6">
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name="subcat_name" placeholder=" Sub Category Name" required>
                              </div>
                          </div>
                          <div class="col-md-6">
                              <div class="form-group">
                                  <label> Sub Category Slug</label>
                                  <input type="text" class="form-control" name="subcat_slug" placeholder=" Sub Category Slug" required>
                              </div>
                          </div>
                          <div class="col-md-6">
                              <div class="form-group">
