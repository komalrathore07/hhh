@extends('layout')
@section('title') Banarsi lehnga House - FAQ'S @endsection
...
<h1 align="center" class="black-text col-md-12" style="font-weight:bold;">Shipping & Returns</h1>
  ...
  <p align="center">Banarsi lehnga House will give more priority to the customer's happiness.We deliver the orders at the best quality with the best pricing</p>
