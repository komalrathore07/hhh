@extends('layout')
@section('title') Banarsi lehnga House About Us @endsection
...
THE Banarsi lehnga House STORY</h3>
<p class="white-text" style="font-weight:bold;">    JOURNEY OF Banarsi lehnga House</p>
